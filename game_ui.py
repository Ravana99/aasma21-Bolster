...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, numAgents):
        ...
        for i in range(0, numAgents):
            ...
            self.villages[i].BuildingLevel = QtWidgets.QLabel(self.centralwidget)
            ...
            self.villages[i].BuildingNextLevel = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        for i in range(0, len(self.villages)):
            ...
            self.villages[i].VillageType.setText(_translate("MainWindow", "Agressive"))
